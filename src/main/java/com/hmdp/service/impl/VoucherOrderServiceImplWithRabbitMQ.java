...
@Slf4j
@Primary
public class VoucherOrderServiceImplWithRabbitMQ extends ServiceImpl<VoucherOrderMapper, VoucherOrder> implements IVoucherOrderService {
    ...
    public VoucherOrderServiceImplWithRabbitMQ(StringRedisTemplate stringRedisTemplate, RabbitTemplate rabbitTemplate, ISeckillVoucherService iSeckillVoucherService) {
